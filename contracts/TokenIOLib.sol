...
library TokenIOLib {
   ...
   */
  function setTokenName(Data storage self, string tokenName) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setTokenSymbol(Data storage self, string tokenSymbol) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setTokenTLA(Data storage self, string tokenTLA) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setTokenVersion(Data storage self, string tokenVersion) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setTokenDecimals(Data storage self, string currency, uint tokenDecimals) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setFeeBPS(Data storage self, uint feeBPS) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setFeeMin(Data storage self, uint feeMin) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setFeeMax(Data storage self, uint feeMax) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setFeeFlat(Data storage self, uint feeFlat) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setFeeContract(Data storage self, address feeContract) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setTokenNameSpace(Data storage self, string currency) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setKYCApproval(Data storage self, address account, bool isApproved, string issuerFirm) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setAccountStatus(Data storage self, address account, bool isAllowed, string issuerFirm) public returns (bool success) {
   ...
   * @return {"success" : "Returns true when successfully called from another contract"}
   */
  function setForwardedAccount(Data storage self, address originalAccount, address forwardedAccount) public returns (bool success) {
   ...
   */
  function getForwardedAccount(Data storage self, address account) public view returns (address registeredAccount) {
   ...
   */
  function getKYCApproval(Data storage self, address account) public view returns (bool status) {
      bytes32 id = keccak256(abi.encodePacked('account.kyc', getForwardedAccount(self, account)));
   ...
   */
  function getAccountStatus(Data storage self, address account) public view returns (bool status) {
    bytes32 id = keccak256(abi.encodePacked('account.allowed', getForwardedAccount(self, account)));
    return self.Storage.getBool(id);
  }
   ...
   */
  function getTokenNameSpace(Data storage self, string currency) public view returns (address contractAddress) {
    bytes32 id = keccak256(abi.encodePacked('token.namespace', currency));
   ...
   */
  function getTokenName(Data storage self, address contractAddress) public view returns (string tokenName) {
   ...
   */
  function getTokenSymbol(Data storage self, address contractAddress) public view returns (string tokenSymbol) {
   ...
   */
  function getTokenTLA(Data storage self, address contractAddress) public view returns (string tokenTLA) {
   ...
   */
  function getTokenVersion(Data storage self, address contractAddress) public view returns (string) {
   ...
   */
  function getTokenDecimals(Data storage self, string currency) public view returns (uint tokenDecimals) {
    bytes32 id = keccak256(abi.encodePacked('token.decimals', currency));
   ...
   */
  function getFeeBPS(Data storage self, address contractAddress) public view returns (uint feeBps) {
   ...
   */
  function getFeeMin(Data storage self, address contractAddress) public view returns (uint feeMin) {
   ...
   */
  function getFeeMax(Data storage self, address contractAddress) public view returns (uint feeMax) {
   ...
   */
  function getFeeFlat(Data storage self, address contractAddress) public view returns (uint feeFlat) {
   ...
   * @return { "success" : "Returns true when successfully called from another contract"}
   */
  function setMasterFeeContract(Data storage self, address contractAddress) public returns (bool success) {
   ...
   */
  function getMasterFeeContract(Data storage self) public view returns (address masterFeeContract) {
    bytes32 id = keccak256(abi.encodePacked('fee.contract.master'));
    return self.Storage.getAddress(id);
  }
   ...
   */
  function getFeeContract(Data storage self, address contractAddress) public view returns (address feeContract) {
   ...
   */
  function getTokenSupply(Data storage self, string currency) public view returns (uint supply) {
   ...
   */
  function getTokenAllowance(Data storage self, string currency, address account, address spender) public view returns (uint allowance) {
   ...
   */
  function getTokenBalance(Data storage self, string currency, address account) public view returns (uint balance) {
   ...
   */
  function getTokenFrozenBalance(Data storage self, string currency, address account) public view returns (uint frozenBalance) {
   ...
   */
  function setTokenFrozenBalance(Data storage self, string currency, address account, uint amount) public view returns (bool success) {
    bytes32 id = keccak256(abi.encodePacked('token.frozen', currency, getForwardedAccount(self, account)));
   ...
   */
  function calculateFees(Data storage self, address contractAddress, uint amount) public view returns (uint calculatedFees) {
   ...
   */
  function verifyAccounts(Data storage self, address accountA, address accountB) public returns (bool verified) {
   ...
   */
  function verifyAccount(Data storage self, address account) public returns (bool verified) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function transfer(Data storage self, string currency, address to, uint amount, bytes data) public returns (bool success) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function transferFrom(Data storage self, string currency, address from, address to, uint amount, bytes data) public returns (bool success) {
    require(address(to) != 0x0);
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function forceTransfer(Data storage self, string currency, address from, address to, uint amount, bytes data) public returns (bool success) {
    require(address(to) != 0x0);
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function updateAllowance(Data storage self, string currency, address account, uint amount) public returns (bool success) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function approveAllowance(Data storage self, address spender, uint amount) public returns (bool success) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function deposit(Data storage self, string currency, address account, uint amount, string issuerFirm) public returns (bool success) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function withdraw(Data storage self, string currency, address account, uint amount, string issuerFirm) public returns (bool success) {
    bytes32 id_a = keccak256(abi.encodePacked('token.balance', currency, getForwardedAccount(self, account)));
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function setRegisteredFirm(Data storage self, string issuerFirm, bool approved) public returns (bool success) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function setRegisteredAuthority(Data storage self, string issuerFirm, address authorityAddress, bool approved) public returns (bool success) {
   ...
   */
  function getFirmFromAuthority(Data storage self, address authorityAddress) public view returns (string issuerFirm) {
   ...
   */
  function isRegisteredFirm(Data storage self, string issuerFirm) public view returns (bool registered) {
    bytes32 id = keccak256(abi.encodePacked('registered.firm', issuerFirm));
    return self.Storage.getBool(id);
  }
   ...
   */
  function isRegisteredToFirm(Data storage self, string issuerFirm, address authorityAddress) public view returns (bool registered) {
   ...
   */
  function isRegisteredAuthority(Data storage self, address authorityAddress) public view returns (bool registered) {
   ...
   */
  function getTxStatus(Data storage self, bytes32 txHash) public view returns (bool txStatus) {
   ...
   * @return { "success" : "Return true if successfully called from another contract" }
   */
  function setTxStatus(Data storage self, bytes32 txHash) public returns (bool success) {
    bytes32 id = keccak256(abi.encodePacked('tx.status', txHash));
   ...
   * @return {"success" : "Returns true if successfully called from another contract"}
   */
  function setDeprecatedContract(Data storage self, address contractAddress) public returns (bool success) {
   ...
   */
  function isContractDeprecated(Data storage self, address contractAddress) public view returns (bool status) {
    bytes32 id = keccak256(abi.encodePacked('depcrecated', contractAddress));
    return self.Storage.getBool(id);
  }
   ...
   */
  function setAccountSpendingPeriod(Data storage self, address account, uint period) public returns (bool success) {
   ...
   */
  function getAccountSpendingPeriod(Data storage self, address account) public view returns (uint period) {
    bytes32 id = keccak256(abi.encodePacked('limit.spending.period', account));
    return self.Storage.getUint(id);
  }
   ...
   * @return {"success" : "Returns true is successfully called from a contract"}
   */
  function setAccountSpendingLimit(Data storage self, address account, uint limit) public returns (bool success) {
   ...
   */
  function getAccountSpendingLimit(Data storage self, address account) public view returns (uint limit) {
    bytes32 id = keccak256(abi.encodePacked('account.spending.limit', account));
    return self.Storage.getUint(id);
  }
   ...
   * @return {"success" : "Returns true is successfully called from a contract"}
   */
  function setAccountSpendingAmount(Data storage self, address account, uint amount) public returns (bool success) {
   ...
   * @return {"success" : "Returns true is successfully called from a contract"}
   */
  function updateAccountSpendingPeriod(Data storage self, address account) public returns (bool success) {
   ...
   */
  function getAccountSpendingAmount(Data storage self, address account) public view returns (uint amount) {
    bytes32 id = keccak256(abi.encodePacked('account.spending.amount', account, getAccountSpendingPeriod(self, account)));
    return self.Storage.getUint(id);
  }
   ...
   */
  function getAccountSpendingRemaining(Data storage self, address account) public view returns (uint remainingLimit) {
   ...
   * @return { "success": "Returns true if successfully called from another contract"}
   */
  function setFxUSDBPSRate(Data storage self, string currency, uint bpsRate) public returns (bool success) {
   ...
   */
  function getFxUSDBPSRate(Data storage self, string currency) public view returns (uint bpsRate) {
    bytes32 id = keccak256(abi.encodePacked('fx.usd.rate', currency));
    return self.Storage.getUint(id);
  }
   ...
   */
  function getFxUSDAmount(Data storage self, string currency, uint fxAmount) public view returns (uint amount) {
